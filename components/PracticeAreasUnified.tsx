...
const practiceAreas = [
  ...
  },
  {
    ...
    expandedDescription: "Muchos conflictos penales tienen raíz o consecuencias en el ámbito civil, comercial o laboral. Los abordamos de forma coordinada con estudios especializados con los que trabajamos habitualmente: Estudio Echavarría Coll (civil y comercial) y Espinosa Paz (laboral).",
    services: [
      "Daños y perjuicios",
